...
const { validateCreateReservation } = require('../validators/reservationValidator');
...
router.post('/', authRequired, validateCreateReservation, validateRequest, reservationController.createReservation);
